...
`solutions/` хранит markdown-файлы для задач типов `write`, `fix` и `idea`. В hosted-версии эти решения попадают в раздел `Разборы`, где участники могут открыть код, перейти в GitHub и оставить комментарий.
...
- Уведомления.
- XP за ревью и уведомления об ответах в разборе.
